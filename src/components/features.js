    ...
    <div className='features' ref={props.FeaturesRef}>
      ...
      <div className='features-flex'>
        ...
        <div className='features-box'>
          ...
          <h1>Anti-Whale</h1>
          <p>
            Max Tx Sell – 1 % Max Wallet when start 2% (increase when hit the
            certain market cap)
          </p>
        </div>
        <div className='features-box'>
          ...
          <h1>Buy Back From our Team</h1>
          <p>
            We will help buyback from our team budget to help the chart (more
            volume , more buy back)
          </p>
        </div>
      </div>
    </div>
